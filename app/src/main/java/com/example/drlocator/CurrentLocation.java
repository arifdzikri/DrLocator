...
public class CurrentLocation extends AppCompatActivity {
    ...
    private void askPermission() {
        ...
        ActivityCompat.requestPermissions(CurrentLocation.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},REQUEST_CODE);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull @org.jetbrains.annotations.NotNull String[] permissions, @NonNull @org.jetbrains.annotations.NotNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE){
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(CurrentLocation.this,"Please provide the required permission",Toast.LENGTH_SHORT).show();
